...
<%
    if (request.getParameter("name") != null) {
        ...
        obj.setModel(request.getParameter("model"));
        dao.incluir(obj);
        dao.fecharEmf();
        System.gc();
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Cadastrar sensor</h4>
                    </div>
                    <div class="content">
                        <form action="main.jsp" method="GET">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Modelo</label>
                                        <input type="text" class="form-control border-input" placeholder="Modelo" name="model">
                                    </div>
                                </div>
